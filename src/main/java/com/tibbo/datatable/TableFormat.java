...
public class TableFormat implements Cloneable {
    private final List<FieldFormat<Object>> fields = new ArrayList<>();
    ...
    public TableFormat addField(FieldFormat<Object> fieldFormat) {
        for (FieldFormat<Object> ff : fields)
    ...
    public FieldFormat<Object> getField(int index) {
        if (index < 0 || index >= fields.size())
            throw new IndexOutOfBoundsException("Index invalid");
        return fields.get(index);
    }

    public FieldFormat<Object> getField(String name) {
    ...
    public void removeField(FieldFormat<Object> fieldFormat) {
